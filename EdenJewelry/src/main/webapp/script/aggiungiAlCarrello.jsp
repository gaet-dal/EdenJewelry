...
<header>
    ...
    <div class="icons">
        <a href="<c:url value='/profiloUtente.jsp' />"><img src="${pageContext.request.contextPath}/assets/images/user-icon.png" alt="Profilo Utente"></a>
        <p>Profilo</p>
        <img src="${pageContext.request.contextPath}/assets/images/wishlist-icon.png" alt="Wishlist">
        <p>Wishlist</p>
        <img src="${pageContext.request.contextPath}/assets/images/cart-icon.png" alt="Carrello">
        <p>Carrello</p>
    </div>
</header>
